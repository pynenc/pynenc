...
def test_causes_cycle(invocations: tuple, app_instance: "Pynenc") -> None:
    ...
    expected_error = (
        ...
        "- #task_id#pynenc_tests.unit.orchestrator.test_cycle_control_all_instances.task2#args_id#no_args\n"
        "- #task_id#pynenc_tests.unit.orchestrator.test_cycle_control_all_instances.task0#args_id#no_args\n"
        "- #task_id#pynenc_tests.unit.orchestrator.test_cycle_control_all_instances.task1#args_id#no_args\n"
        "- back to #task_id#pynenc_tests.unit.orchestrator.test_cycle_control_all_instances.task2#args_id#no_args"
    )
...
def test_remove_invocation(invocations: tuple, app_instance: "Pynenc") -> None:
    ...
    app_instance.orchestrator._atomic_status_transition(
        invocation1.invocation_id, InvocationStatus.SUCCESS, runner_id
    )
    graph.clean_up_invocation_cycles(invocation1.invocation_id)
